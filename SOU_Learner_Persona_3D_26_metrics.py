...
#Ploting a variable factor map in the space (i.e. vectors of 26 metrics in the space consisting of the 3 PCs)
from mpl_toolkits.mplot3d import axes3d
...
colors = {0:'purple', 1:'seagreen', 2:'gold'}    #predicted to be 0 = purple; 1 = seagreen; 2 = gold
PSG=df_Learners_3_3PC['cluster'].apply(lambda x: colors[x])    #matching predicted labes with colors
...
n = ['cluster 1', 'cluster 2', 'cluster 3']    #matching predicted labes with cluster names
